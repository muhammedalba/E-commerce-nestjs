...
export class CreateCouponDto {
  ...
  @ApiPropertyOptional({
    description: 'Array of item IDs the coupon applies to',
    type: [String],
  ...
  @ApiPropertyOptional({
    description: 'Minimum order amount for the coupon to be valid',
    default: 0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    description: 'Maximum order amount for the coupon to be valid',
  })
  @IsNumber()
  @Min(0)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Array of user IDs who have used the coupon',
    type: [String],
  })
  @IsArray()
  @IsString({ each: true })
